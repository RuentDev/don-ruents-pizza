...
const LocationsSection: React.FunctionComponent<LocationsSectionProps> = (
  props,
) => {
  return (
    <section className="gallery-section  max-w-7xl mx-auto px-6 md:px-0">
      <h2
        style={lilita.style}
        className="text-[3rem] text-colorPrimary text-center mt-5 mb-2"
      >
        Our locations
      </h2>
